##
<img align="top" align ="middle" alt="GIF" src="https://i.giphy.com/media/YQGTMkgCZpOpdnNX5R/giphy.webp"  width="500" height="320" /><br><br>using Berke.Collections;    <br>using Berke.Information;     <br>using Berke.Details;<br><br>public class Berke : GameDeveloper                           <br>{                                                                        <br>  const string NAME = "Berke";                                   <br>  int _age = 24;                                    <br>          enum Interests {
            GAME_DEVELOPMENT, 
            PROGRAMMING, 
            LEARNING, 
            GAME_DESIGN, 
